...
def create_animal():
    ...
    id_raza = Utils.validate_json_field(data, 'id_raza', True, int)
    ...
    result = AnimalService.create_animal(identificacion_animal, id_raza, id_madre, id_padre, procedencia, fecha_nacimiento_date)
...
def update_animal(identificacion_animal):
    ...
    procedencia = Utils.validate_json_field(data, 'procedencia', True, int)
    fecha_nacimiento_date = Utils.convert_to_date(fecha_nacimiento, '%Y-%m-%d')
    result = AnimalService.update_animal(identificacion_animal, id_raza, id_madre, id_padre, procedencia, fecha_nacimiento_date)
    return jsonify({ "success": True, "data": result })
